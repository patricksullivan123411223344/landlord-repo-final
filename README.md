...
#this (WEBSITE) is to find affordable housing for Providence, Rhode Island and planing to grow and expand to the state over time.
...
Average ratings displayed publicly
Price Point Selection
Users can filter rentals by:
Minimum price
Maximum price
Helps renters stay within budget
Simple & Accessible Interface
Clean layout
Easy navigation
Mobile-friendly design
Integration with public housing datasets
